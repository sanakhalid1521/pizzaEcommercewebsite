...
import barbecue from '../public/images/kababish.jpg';
            ...
            <div className='flex flex-col'>
              <a
                ...
                <Image
                  ...
                  width={200}
                  height={150}
                  className='w-full h-42 object-cover transition-transform duration-500 ease-in-out group-hover:scale-105'
                />
                <h3 className='text-lg font-medium text-white text-center mt-2'>
